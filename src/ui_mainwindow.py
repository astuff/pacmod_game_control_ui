...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pacmod_label.setStyleSheet(_fromUtf8("background-color: green; border-px: 0"))
        ...
        self.acceleration_label.setStyleSheet(_fromUtf8("background-color: black; color: white"))
        ...
        "/home/demo/standard_ws/src/pacmod_game_control_ui/autonomy_images/as_no_bg(80).png")))
