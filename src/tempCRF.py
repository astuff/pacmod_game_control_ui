...
class JoyGui(object):
    ...
    def __init__(self, main_class1):

        self.which_run = "spin" # spin or while
        self.main_class = main_class1
        self.enable = self.main_class.enable
        self.override = self.main_class.timeout
        self.timeout = self.main_class.override
...
if __name__ == "__main__":
    ...
    joyGui = JoyGui( JoyGui.main_class1)
